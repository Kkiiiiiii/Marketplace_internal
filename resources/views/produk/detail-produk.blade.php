                    ...
                    <div class="row">
                                ...
                                @if ($produk->gambarProduk->count() > 0)
                                    <div class="ratio ratio-4x3">
                                        <img id="main-product-image"
                                            ...
                                            class="w-100 h-100 object-fit-cover rounded" alt="{{ $produk->nama_produk }}">
                                    </div>
                                @else
                                    <img id="main-product-image" src="{{ asset('produk.png') }}" class="img-fluid"
                        ...
                        <div class="col-lg-6 ps-lg-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <form action="{{ route('wishlist.add', $produk->id_produk) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    <button type="submit" class="btn p-0 bg-transparent border-0">
                                        <i class="bi bi-heart text-danger" style="font-size: 22px"></i>
                                    </button>
                                </form>
                            ...
                            <div class="mt-4 pt-3 border-top">
                                <a href="https://wa.me/1234567890?text=Halo%2C+saya+tertarik+dengan+produk+{{ urlencode($produk->nama_produk) }}"
                                    class="btn btn-success w-100 fw-semibold py-2" target="_blank">
