                        ...
                        <div class="card h-100 shadow-sm">
                            @if ($w->produk->gambarProduk->first())
                                <img src="{{ asset('storage/' . $w->produk->gambarProduk->first()->nama_gambar) }}"
                                    class="card-img-top" alt="{{ $w->produk->nama_produk }}"
                                    style="height:200px; object-fit:cover;">
                            @else
                                <img src="{{ asset('image/no_image.png') }}" class="card-img-top" alt="Tidak ada gambar"
                                    style="height:200px; object-fit:cover;">
                            @endif
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mt-auto d-flex flex-column gap-2 mb-2">
                                    <!-- Detail Produk -->
                                    <a href="{{ route('produk-detail', Crypt::encrypt($w->id_produk)) }}" class="btn btn-success btn-sm w-auto">
                                ...
                                <div class="d-flex justify-content-between">
                                    <!-- Hapus dari Wishlist -->
                                    <form action="{{ route('HapusWish',Crypt::encrypt($w->id)) }}" method="POST" class="w-auto">
                                        @csrf
